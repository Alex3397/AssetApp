...
const UserDefinedFields = (props) => {
    ...
    if (
        (props.item.userDefinedFields.udfChkBox01 != ""
        || props.item.userDefinedFields.udfChkBox02 != ""
        || props.item.userDefinedFields.udfChkBox03 != ""
        || props.item.userDefinedFields.udfChkBox04 != ""
        || props.item.userDefinedFields.udfChkBox05 != ""
        || props.item.userDefinedFields.udfChkBox06 != ""
        || props.item.userDefinedFields.udfChkBox07 != ""
        || props.item.userDefinedFields.udfChkBox08 != ""
        || props.item.userDefinedFields.udfChkBox09 != ""
        || props.item.userDefinedFields.udfChkBox10 != "") && checkPadding != 10
    ) {
        setCheckPadding(10);
    }
        ...
        <View style={{ backgroundColor: colors.card, padding: 10, margin: 10, borderRadius: 25 }}>
            ...
            <View>
                ...
                <View style={{ margin: checkPadding }}>
                    <HideableTextField label={props.userLabels.udfChkBox01Label} data={props.item.userDefinedFields.udfChkBox01} />
                    <HideableTextField label={props.userLabels.udfChkBox02Label} data={props.item.userDefinedFields.udfChkBox02} />
                    <HideableTextField label={props.userLabels.udfChkBox03Label} data={props.item.userDefinedFields.udfChkBox03} />
                    <HideableTextField label={props.userLabels.udfChkBox04Label} data={props.item.userDefinedFields.udfChkBox04} />
                    <HideableTextField label={props.userLabels.udfChkBox05Label} data={props.item.userDefinedFields.udfChkBox05} />
                    <HideableTextField label={props.userLabels.udfChkBox06Label} data={props.item.userDefinedFields.udfChkBox06} />
                    <HideableTextField label={props.userLabels.udfChkBox07Label} data={props.item.userDefinedFields.udfChkBox07} />
                    <HideableTextField label={props.userLabels.udfChkBox08Label} data={props.item.userDefinedFields.udfChkBox08} />
                    <HideableTextField label={props.userLabels.udfChkBox09Label} data={props.item.userDefinedFields.udfChkBox09} />
                    <HideableTextField label={props.userLabels.udfChkBox10Label} data={props.item.userDefinedFields.udfChkBox10} />
                </View>
